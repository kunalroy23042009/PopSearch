var CCR = (() => {
        ...
        callback: async (response) => {
          try {
            ...
            if (res.ok) login(d.access_token, d.user);
              ...
              setErr(d.detail || "Google sign-in failed");
              setGLoading(false);
            }
          } catch {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { style: { width: 52, height: 52, borderRadius: "50%", background: "rgba(255,68,68,.1)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 14px", fontSize: "1.5rem" } },
            React.createElement(
              "svg",
        ...
        window.CCR_GOOGLE_CLIENT_ID ? React.createElement(
          React.Fragment,
          null,
        ...
        React.createElement(
          "p",
          { style: { textAlign: "center", marginTop: 20, fontSize: ".85rem", color: "var(--text3)" } },
        ...
        callback: async (response) => {
          try {
            ...
            if (res.ok) login(d.access_token, d.user);
              ...
              setErr(d.detail || "Google sign-up failed");
              setGLoading(false);
            }
          } catch {
            setErr("Network error");
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { style: { width: 52, height: 52, borderRadius: "50%", background: "rgba(62,166,255,.1)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 14px", fontSize: "1.5rem" } },
            React.createElement(
              "svg",
              { width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", stroke: "var(--accent)", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" },
  ...
  function DashboardPage() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { style: { display: "flex", gap: 8, marginBottom: 20, maxWidth: 500 } },
        ...
        React.createElement("button", { className: "btn btn-primary", onClick: load, disabled: loading }, loading ? "..." : "\u{1F50D}")
      ),
      ...
      !data && !loading ? React.createElement(
        "div",
        { className: "empty-state", style: { marginTop: 48 } },
        React.createElement("div", { className: "emoji", style: { fontSize: "3.5rem" } }, "\u{1F4FA}"),
      ...
      data && p ? React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "p",
                { style: { color: "rgba(255,255,255,.8)", fontSize: ".88rem", lineHeight: 1.5 } },
                fmt(p.subscriber_count),
                " subscribers \xB7 ",
                p.niche || "N/A",
                " \xB7 ",
                p.channel_tier || ""
        ...
        React.createElement(
          "div",
          { className: "tabs" },
          ["overview", "content", "analytics", "competitors"].map(
            (t) => React.createElement("button", {
              key: t,
              className: `tab${tab === t ? " active" : ""}`,
              onClick: () => setTab(t)
            }, t === "overview" ? "\u{1F4CA} Overview" : t === "content" ? "\u{1F4C4} Content" : t === "analytics" ? "\u{1F4C8} Analytics" : "\u{1F465} Competitors")
          )
        ),
        // ── Overview tab ──
        tab === "overview" ? React.createElement(
          ...
          data.trends?.interest_over_time?.length ? React.createElement(
            "div",
            { className: "card" },
            React.createElement(
              "div",
        ...
        // ── Content tab ──
        tab === "content" ? React.createElement(
          "div",
          null,
          p.top_performing_videos?.length ? React.createElement(
            ...
            p.top_performing_videos.slice(0, 8).map(
              (v, i) => React.createElement(
                "div",
                { key: i, style: { display: "flex", justifyContent: "space-between", padding: "10px 0", borderBottom: i < Math.min(p.top_performing_videos.length, 8) - 1 ? "1px solid var(--border)" : "none", gap: 12, alignItems: "center" } },
          ...
          p.underperforming_videos?.length ? React.createElement(
            "div",
            { className: "card" },
            React.createElement(
              "div",
            ...
            p.underperforming_videos.slice(0, 5).map(
              (v, i) => React.createElement("div", { key: i, style: { padding: "8px 0", fontSize: ".85rem", borderBottom: i < Math.min(p.underperforming_videos.length, 5) - 1 ? "1px solid var(--border)" : "none" } }, v.title || `Video ${i + 1}`)
            )
          ) : null,
          p.content_gaps?.length ? React.createElement(
            ...
            React.createElement(
              "div",
              { className: "card-header" },
              React.createElement("div", { className: "card-icon", style: { background: "rgba(255,167,60,.15)", color: "var(--warning)" } }, "\u{1F50D}"),
        ...
        // ── Analytics tab ──
        tab === "analytics" ? React.createElement(
          "div",
          null,
          p.performance_summary ? React.createElement(
            ...
            "div",
            { className: "card", style: { textAlign: "center", padding: 32, color: "var(--text3)" } },
            "Detailed analytics require more video data. Continue analyzing to populate."
          ),
          p.optimization_tips?.length ? React.createElement(
            "div",
            { className: "card" },
            React.createElement(
              "div",
        ...
        // ── Competitors tab ──
        tab === "competitors" ? React.createElement(
          "div",
          null,
          c ? React.createElement(
            ...
            React.createElement(
              "div",
              { className: "card-header" },
              React.createElement("div", { className: "card-icon", style: { background: "rgba(255,167,60,.15)", color: "var(--warning)" } }, "\u{1F465}"),
          ...
          c?.competitors?.length ? React.createElement(
            ...
            React.createElement(
              "div",
              { className: "card-header" },
              React.createElement("div", { className: "card-icon", style: { background: "rgba(62,166,255,.15)", color: "var(--accent)" } }, "\u{1F4CB}"),
          ...
          c?.untapped_niches?.length ? React.createElement(
            "div",
            { className: "card" },
            React.createElement(
              "div",
              { className: "card-header" },
              React.createElement("div", { className: "card-icon", style: { background: "rgba(43,166,64,.15)", color: "var(--success)" } }, "\u{1F31F}"),
  ...
  function CommentsPage() {
    ...
    return React.createElement(
      "div",
      null,
      React.createElement("h1", { style: { fontSize: "1.5rem", fontWeight: 800, marginBottom: 4, letterSpacing: "-.02em" } }, "\u{1F4AC} Comment Analyzer"),
      React.createElement(
        "p",
        { style: { color: "var(--text3)", fontSize: ".9rem", marginBottom: 24, lineHeight: 1.5 } },
  ...
  function PublishingPage() {
    ...
    return React.createElement(
      "div",
      null,
      React.createElement("h1", { style: { fontSize: "1.5rem", fontWeight: 800, marginBottom: 4, letterSpacing: "-.02em" } }, "\u{1F4E4} Publishing Assistant"),
      React.createElement(
        "p",
        { style: { color: "var(--text3)", fontSize: ".9rem", marginBottom: 24, lineHeight: 1.5 } },
  ...
  function AlgoShiftPage() {
    ...
    return React.createElement(
      "div",
      null,
      React.createElement("h1", { style: { fontSize: "1.5rem", fontWeight: 800, marginBottom: 4, letterSpacing: "-.02em" } }, "\u{1F4C8} Algorithm Shift Tracker"),
      React.createElement(
        "p",
        { style: { color: "var(--text3)", fontSize: ".9rem", marginBottom: 24, lineHeight: 1.5 } },
  ...
  function AgentPage() {
    ...
    return React.createElement(
      "div",
      null,
      React.createElement("h1", { style: { fontSize: "1.5rem", fontWeight: 800, marginBottom: 4, letterSpacing: "-.02em" } }, "\u{1F916} Growth Agent"),
      React.createElement(
        "div",
  ...
  function EditingPage() {
    ...
    return React.createElement(
      "div",
      null,
      React.createElement("h1", { style: { fontSize: "1.5rem", fontWeight: 800, marginBottom: 4, letterSpacing: "-.02em" } }, "\u{1F579}\uFE0F Editing Assistant"),
      React.createElement(
        "p",
        { style: { color: "var(--text3)", fontSize: ".9rem", marginBottom: 24, lineHeight: 1.5 } },
      ...
      data?.needs_auth ? React.createElement(
        ...
        React.createElement(
          "p",
          { style: { color: "var(--text3)", marginBottom: 16, fontSize: ".88rem" } },
        ...
        data.editing_tips?.length ? React.createElement(
          ...
          data.editing_tips.map(
            (tip, i) => React.createElement(
              "div",
              { key: i, style: { padding: "8px 0", fontSize: ".88rem", borderBottom: i < data.editing_tips.length - 1 ? "1px solid var(--border)" : "none" } },
              `${i + 1}. ${tip}`
            )
          )
        ) : null,
        data.pacing_advice ? React.createElement(
          "div",
          { className: "card" },
          React.createElement(
            "div",
        ...
        data.hook_suggestion ? React.createElement(
          "div",
          { className: "card" },
          React.createElement(
            "div",
            { className: "card-header" },
            React.createElement("div", { className: "card-icon", style: { background: "rgba(43,166,64,.15)" } }, "\u{1F3A3}"),
        ...
        "div",
        { className: "empty-state" },
        React.createElement("div", { className: "emoji" }, "\u{1F579}\uFE0F"),
